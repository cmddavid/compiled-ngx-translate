...
exports.TranslatePipe = exports.TranslateDirective = exports.TranslateFakeCompiler = exports.TranslateCompiler = exports.TranslateDefaultParser = exports.TranslateParser = exports.FakeMissingTranslationHandler = exports.MissingTranslationHandler = exports.TranslateService = exports.USE_DEFAULT_LANG = exports.USE_STORE = exports.TranslateFakeLoader = exports.TranslateLoader = exports.TranslateModule = exports.ɵa = undefined;
...
var _share = require('rxjs/operators/share');

var _map = require('rxjs/operators/map');

var _merge = require('rxjs/operators/merge');
...
var TranslateFakeLoader = function (_TranslateLoader) {
    _inherits(TranslateFakeLoader, _TranslateLoader);

    function TranslateFakeLoader() {
        _classCallCheck(this, TranslateFakeLoader);

        return _possibleConstructorReturn(this, (TranslateFakeLoader.__proto__ || Object.getPrototypeOf(TranslateFakeLoader)).apply(this, arguments));
    }
...
exports.TranslateFakeLoader = TranslateFakeLoader = __decorate$1([(0, _core.Injectable)()], TranslateFakeLoader);
...
var isArrayLike_1 = function isArrayLike_1(x) {
    return x && typeof x.length === 'number';
};
...
var iterator = createCommonjsModule(function (module, exports) {
    function symbolIteratorPonyfill(root$$2) {
        var _Symbol3 = root$$2.Symbol;
        if (typeof _Symbol3 === 'function') {
            if (!_Symbol3.iterator) {
                _Symbol3.iterator = _Symbol3('iterator polyfill');
            }
            return _Symbol3.iterator;
        } else {
...
exports.FakeMissingTranslationHandler = FakeMissingTranslationHandler = __decorate$3([(0, _core.Injectable)()], FakeMissingTranslationHandler);
...
var TranslateFakeCompiler = function (_TranslateCompiler) {
    ...
    function TranslateFakeCompiler() {
        ...
        return _possibleConstructorReturn(this, (TranslateFakeCompiler.__proto__ || Object.getPrototypeOf(TranslateFakeCompiler)).apply(this, arguments));
    }
...
exports.TranslateFakeCompiler = TranslateFakeCompiler = __decorate$4([(0, _core.Injectable)()], TranslateFakeCompiler);
...
var TranslateDefaultParser = function (_TranslateParser) {
    _inherits(TranslateDefaultParser, _TranslateParser);

    function TranslateDefaultParser() {
        _classCallCheck(this, TranslateDefaultParser);

        var _this4 = _possibleConstructorReturn(this, (TranslateDefaultParser.__proto__ || Object.getPrototypeOf(TranslateDefaultParser)).apply(this, arguments));

        _this4.templateMatcher = /{{\s?([^{}\s]*)\s?}}/g;
        return _this4;
    }
    ...
    _createClass(TranslateDefaultParser, [{
        ...
        value: function getValue(target, key) {
            ...
            do {
                key += keys.shift();
                if (isDefined(target) && isDefined(target[key]) && (_typeof(target[key]) === 'object' || !keys.length)) {
                    target = target[key];
                    key = '';
                } else if (!keys.length) {
                    target = undefined;
        ...
        value: function interpolateString(expr, params) {
            ...
            return expr.replace(this.templateMatcher, function (substring, b) {
                var r = _this5.getValue(params, b);
...
exports.TranslateDefaultParser = TranslateDefaultParser = __decorate$5([(0, _core.Injectable)()], TranslateDefaultParser);
...
var USE_STORE = new _core.InjectionToken('USE_STORE');
var USE_DEFAULT_LANG = new _core.InjectionToken('USE_DEFAULT_LANG');
    ...
    _createClass(TranslateService, [{
        ...
        value: function setDefaultLang(lang) {
            ...
            if (typeof pending !== "undefined") {
                ...
                pending.pipe((0, _take.take)(1)).subscribe(function (res) {
                    _this6.changeDefaultLang(lang);
                });
            } else {
        ...
        value: function use(lang) {
            ...
            if (lang === this.currentLang) {
                return (0, _of.of)(this.translations[lang]);
            }
            var pending = this.retrieveTranslations(lang);
            if (typeof pending !== "undefined") {
        ...
        value: function getTranslation(lang) {
            ...
            this.pending = true;
            this.loadingTranslations = this.currentLoader.getTranslation(lang).pipe((0, _share.share)());
            this.loadingTranslations.pipe((0, _take.take)(1)).subscribe(function (res) {
                _this8.translations[lang] = _this8.compiler.compileTranslations(res, lang);
                _this8.updateLangs();
        ...
        value: function addLangs(langs) {
            ...
            langs.forEach(function (lang) {
                if (_this9.langs.indexOf(lang) === -1) {
                    _this9.langs.push(lang);
                }
            });
        }
        /**
                ...
                if (observables) {
                    ...
                    try {
                        for (var _iterator2 = key[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                            ...
                            var obs = typeof result[k].subscribe === "function" ? result[k] : (0, _of.of)(result[k]);
                            if (typeof mergedObs === "undefined") {
                                mergedObs = obs;
                            } else {
                                mergedObs = mergedObs.pipe((0, _merge.merge)(obs));
                            }
                        }
                    } catch (err) {
                    ...
                    return mergedObs.pipe((0, _toArray.toArray)(), (0, _map.map)(function (arr) {
                        var obj = {};
        ...
        value: function get(key, interpolateParams) {
            ...
            if (this.pending) {
                return _Observable.Observable.create(function (observer) {
                    ...
                    _this10.loadingTranslations.subscribe(function (res) {
                        res = _this10.getParsedResult(_this10.compiler.compileTranslations(res, _this10.currentLang), key, interpolateParams);
        ...
        value: function stream(key, interpolateParams) {
            ...
            return this.get(key, interpolateParams).pipe(concat_3(this.onLangChange.pipe((0, _switchMap.switchMap)(function (event) {
                var res = _this11.getParsedResult(event.translations, key, interpolateParams);
                if (typeof res.subscribe === "function") {
                    return res;
                } else {
                    return (0, _of.of)(res);
...
exports.TranslateService = TranslateService = __decorate$2([(0, _core.Injectable)(), __param(5, (0, _core.Inject)(USE_DEFAULT_LANG)), __param(6, (0, _core.Inject)(USE_STORE)), __metadata("design:paramtypes", [TranslateStore, TranslateLoader, TranslateCompiler, TranslateParser, MissingTranslationHandler, Boolean, Boolean])], TranslateService);
    ...
    function TranslateDirective(translateService, element, _ref) {
        ...
        if (!this.onTranslationChangeSub) {
            this.onTranslationChangeSub = this.translateService.onTranslationChange.subscribe(function (event) {
                if (event.lang === _this12.translateService.currentLang) {
                    _this12.checkNodes(true, event.translations);
                }
            });
        }
            ...
            if (key) {
                ...
                var onTranslation = function onTranslation(res) {
                    ...
                    if (!node.originalContent) {
                        node.originalContent = _this13.getContent(node);
                    }
                    node.currentValue = isDefined(res) ? res : node.originalContent || key;
                    // we replace in the original content to preserve spaces that we might have trimmed
                    _this13.setContent(node, _this13.key ? node.currentValue : node.originalContent.replace(key, node.currentValue));
                    _this13._ref.markForCheck();
                };
...
__decorate$6([(0, _core.Input)(), __metadata$1("design:type", String), __metadata$1("design:paramtypes", [String])], TranslateDirective.prototype, "translate", null);
__decorate$6([(0, _core.Input)(), __metadata$1("design:type", Object), __metadata$1("design:paramtypes", [Object])], TranslateDirective.prototype, "translateParams", null);
exports.TranslateDirective = TranslateDirective = __decorate$6([(0, _core.Directive)({
    selector: '[translate],[ngx-translate]'
}), __metadata$1("design:paramtypes", [TranslateService, _core.ElementRef, _core.ChangeDetectorRef])], TranslateDirective);
...
var TranslatePipe = function () {
    ...
    _createClass(TranslatePipe, [{
        ...
        value: function updateValue(key, interpolateParams, translations) {
            ...
            var onTranslation = function onTranslation(res) {
                _this14.value = res !== undefined ? res : key;
                _this14.lastKey = key;
                _this14._ref.markForCheck();
            };
            if (translations) {
        ...
        value: function transform(query) {
            ...
            if (!this.onTranslationChange) {
                this.onTranslationChange = this.translate.onTranslationChange.subscribe(function (event) {
                    if (_this15.lastKey && event.lang === _this15.translate.currentLang) {
                        _this15.lastKey = null;
                        _this15.updateValue(query, interpolateParams, event.translations);
                    }
                });
            }
            // subscribe to onLangChange event, in case the language changes
            if (!this.onLangChange) {
                this.onLangChange = this.translate.onLangChange.subscribe(function (event) {
                    if (_this15.lastKey) {
                        _this15.lastKey = null; // we want to make sure it doesn't return the same value until it's been updated
                        _this15.updateValue(query, interpolateParams, event.translations);
                    }
                });
            }
            ...
            if (!this.onDefaultLangChange) {
                this.onDefaultLangChange = this.translate.onDefaultLangChange.subscribe(function () {
                    if (_this15.lastKey) {
                        _this15.lastKey = null; // we want to make sure it doesn't return the same value until it's been updated
                        _this15.updateValue(query, interpolateParams);
                    }
                });
            }
            return this.value;
...
exports.TranslatePipe = TranslatePipe = __decorate$7([(0, _core.Injectable)(), (0, _core.Pipe)({
    name: 'translate',
    pure: false // required to update the value when the promise is resolved
}), __metadata$2("design:paramtypes", [TranslateService, _core.ChangeDetectorRef])], TranslatePipe);
...
var TranslateModule = TranslateModule_1 = function () {
    ...
    _createClass(TranslateModule, null, [{
        ...
        value: function forChild() {
            ...
            return {
                ngModule: TranslateModule_1,
                providers: [config.loader || { provide: TranslateLoader, useClass: TranslateFakeLoader }, config.compiler || { provide: TranslateCompiler, useClass: TranslateFakeCompiler }, config.parser || { provide: TranslateParser, useClass: TranslateDefaultParser }, config.missingTranslationHandler || { provide: MissingTranslationHandler, useClass: FakeMissingTranslationHandler }, { provide: USE_STORE, useValue: config.isolate }, { provide: USE_DEFAULT_LANG, useValue: config.useDefaultLang }, TranslateService]
            };
        }
    }]);
...
exports.TranslateModule = TranslateModule = TranslateModule_1 = __decorate([(0, _core.NgModule)({
